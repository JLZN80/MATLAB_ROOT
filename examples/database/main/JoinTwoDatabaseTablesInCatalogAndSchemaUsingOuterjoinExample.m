...
% |productTable| table is the left table of the join, and the |suppliers|
% table is the right table of the join. The |sqlouterjoin| function
% automatically detects the shared column between the tables. Specify the
% |toy_store| catalog and the |dbo| schema for both the left and right
% tables. Use the |'LeftCatalog'| and |'LeftSchema'| name-value pair
% arguments for the left table, and the |'RightCatalog'| and
% |'RightSchema'| name-value pair arguments for the right table.
% 
