...
% object, read the data stored in the object, and retrieve information
% about the database.
%
...
%%
% Read the data in the |DatabaseDatastore| object, and retrieve information
% about the database.

[data,info] = read(dbds)

%%
% |data| contains the query results. The structure |info| contains the
% data source name |datasource| and current cursor position |offset|.
