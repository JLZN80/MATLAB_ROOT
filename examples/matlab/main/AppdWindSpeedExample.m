...
% This app shows how to create a timer object in App Designer that executes
% a function at regular time intervals. In this case, the app queries the
% wind speed from a web site every five seconds and plots the returned
% value.
%
% This example also demonstrates the following app building tasks:
%
% * Writing a callback for an object created programmatically (in this
% case, the timer object)
