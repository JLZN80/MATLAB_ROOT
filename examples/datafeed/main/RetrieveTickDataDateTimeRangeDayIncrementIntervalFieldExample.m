...
% each day in a specific date range. Specify a day increment for the date
% range, the time interval for the tick data, and the field for the type
% of tick data to return. Here, specify the bid tick data.
...
% aggregated into 5-minute intervals. Specify the bid tick series. |d| is a
% numeric matrix.
