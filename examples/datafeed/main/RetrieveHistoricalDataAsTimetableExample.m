...
% for a historical date range. The |history| function returns data as a
% |timetable|.
...
% of the connection object. If you do not set this property, the |history|
...
% August 10, 2010. |d| is a |timetable| that contains dates in the first
% column.
